...
1.  If yes, the system proceeds directly to section @sec-preview-of-verified-training-data.
...
1.  The user reviews the TrainData Recap displayed in a table.
2.  The user selects one of the following options for splitting the sample:
    -   Use all sample points, or

    -   Split sample points into training and validation, specifying the desired percentage.

**Back-end**

1.  The system presents a recap table with columns for ID, class, number of points, and percentage.
2.  The system provides options for splitting the sample point data for training and validation:
    -   Use all sample points for training - the system consolidates all data into a single DataFrame or variable, stored as Train Data Final for use in [Module 4](@sec-module4) and [6](@sec-module-6).

    -   Split the sample points between training and validation - the system partitions the data according to the user-specified percentage. The Train Data Final (for training) is stored in [Module 4](@sec-module-4) and [6](@sec-module-6), while Valid Data Final (for validation) is stored in Module [6](@sec-module-6).

## Data Splitting

1.  The user selects one of the following options for splitting the sample:
    -   Use all sample points, or
