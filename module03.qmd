...
2.  Users with training data who created their own classification model in [Module 2](@sec-module-2) can either [upload their data](@sec-user-uploading-their-own-training-data) or and [enter it manually](@sec-on-screen-sampling) (Phase 1).
