...
1.  The system supports shapefile in `.ZIP` format.
2.  An Upload button is provided. The system extracts the content to a temporary directory and recursively searches all subfolders for files.
3.  The system displays a small preview map centered on the AOI.
...
1.  The system uses multi-temporal Landsat imagery as a default data source.\
