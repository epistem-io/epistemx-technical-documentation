...
::: callout-tip
Related Functions multiclass_classification() to perform multiclass hard classification to generate land cover land use map using Random Forest with specified parameters. ovr_classification() to implement one-vs-rest binary classification for multi-class land cover, generating probability stacks and optional final map via argmax.
:::
