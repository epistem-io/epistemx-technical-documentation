...
4.  Validation dataset if available ([Module 3](@sec-module-3)).
5.  Optimized covariates if used ([Module 5](@sec-module-5)).
6.  Validated sample data and separability results ([Module 4](@sec-module-4)).
