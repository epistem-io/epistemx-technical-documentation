...
The user fills in four columns: ID, Level, Class Name, and Colour, with a hierarchical User Interface (UI) form to simplify creating multi-level class structures.

**Back-end**

The system receives user’s input and saves it as a variable.

### Non-Hierarchical Classification Schema {#sec-non-hierarchical-classification-schema}

#### Front-end

The user fills in four columns: ID, Level, Class Name, and Colour.
...
The user receives a confirmation and can proceed to the next step.

#### Back-end

Once validated, the system saves the classification table as a variable to use in subsequent modules.
