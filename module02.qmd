...
If the user choose hierarchical schema, the system proceeds to @sec-hierarchical-classification-schema

If the user choose non-hierarchical schema, the system proceeds to @sec-non-hierarchical-classification-schema
