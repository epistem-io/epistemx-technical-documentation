...
## Computing the Separability Analysis {#sec-run-separability-analysis}

### Computing the Separability Analysis

**Back-end**

1.  The system executes the separability analysis workflow that consist of two processes: **Sample Statistics Calculation** and **Separability Analysis**

2.  The system executes the workflow of **Sample Statistics Calculation** as follows:
...
3.  The system executes the workflow of **Separability Analysis** as follows:
