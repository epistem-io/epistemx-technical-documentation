...
1.  Use a Pre-Trained Model (from the system or another users).
2.  Train a New Model.
...
2.  If incompatible, the system recommends the user to click the option Train a New Model.
